...
- 採用手法は大きく「エージェントマネジメント」と「ダイレクトリクルーティング」に分かれる

- エージェントは"待ち"の姿勢、ダイレクトは"攻め"の姿勢
...
- エージェントが我々に営業するのではなくて、我々が営業に対してチャネルパートナーとして営業をしなければならない

- ダイレクトリクルーティングは顕在層ではなく潜在層をやろう
